...
\kvpl{aplikacja desktopowa, gra z gatunku bijatyk 2D, interakcja z użytkownikiem, tryb offline, tryb online} % INFO: słowa kluczowe po polsku
\kven{desktop application, 2D fighting game, user interaction, offline mode, online mode} % INFO: słowa kluczowe po angielsku
