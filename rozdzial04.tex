...
%chętnie dostalbym informacje zwrotną czy lepiej żeby opisy testów były w takim formacie, czy moze lepiej podzielic je na punkty jak np. 1. cel testu, 2. srodowisko testowe, 3. kroki testowe, 4. oczekiwane wyniki, 5. Wynik testu lub inne

% TO DO: Jak dla mnie opis jest poprawny. Kroki, które Pan wymienił w zapytaniu powyżej lepiej pasują do testów akceptacyjnych niż jednostkowych. Tak więc opis może zostać jak jest.
