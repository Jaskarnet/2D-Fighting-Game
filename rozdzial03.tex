...
\subsection{Klasa OfflineGameScreen}
...
\begin{lstlisting}[language=Java,style=JavaStyle,label=list:offline_game,caption=Klasa OfflineGameScreen,
                   basicstyle=\footnotesize\ttfamily]
